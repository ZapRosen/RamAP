...
der mini-fakedns-server läuft nun mit python3. Einige Tests verliefen fehlerfrei. Das pi shutdown skript läuft zur Zeit nicht und befindet sich auch nicht im neu geschriebenen install-skript.
